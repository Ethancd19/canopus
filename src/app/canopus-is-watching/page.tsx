  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (const s of stars) {
        ...
        ctx.fillStyle = `rgba(212,220,232,${twinkle})`;
        ctx.fill();
      }
      ...
      glow.addColorStop(0, `rgba(168,197,218,${pulse})`);
      glow.addColorStop(0.4, `rgba(168,197,218,${pulse * 0.35})`);
      glow.addColorStop(1, "rgba(168,197,218,0)");
      ctx.beginPath();
...
function CursorTrail() {
  ...
  useEffect(() => {
    const onMove = (e: MouseEvent) => {
      ...
      const vel =
        Math.sqrt(dx * dx + dy * dy) / Math.max(now - lastRef.current.t, 1);
      if (vel > 0.25) {
      ...
      {dots.map((dot) => (
        <motion.div
          ...
          style={{
            ...
            height: "6px",
            borderRadius: "50%",
            background: "rgba(168,197,218,0.85)",
            boxShadow: "0 0 8px rgba(168,197,218,0.6)",
            zIndex: 50,
            pointerEvents: "none",
          }}
        />
            ...
            >
              ...
              <motion.button
                ...
                style={{
                  ...
                  border: "0.5px solid rgba(212,220,232,0.15)",
                  color: "rgba(212,220,232,0.35)",
                  cursor: "pointer",
                  transition: "color 0.2s, border-color 0.2s",
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = "rgba(212,220,232,0.9)";
                  e.currentTarget.style.borderColor = "rgba(212,220,232,0.4)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.color = "rgba(212,220,232,0.35)";
                  e.currentTarget.style.borderColor = "rgba(212,220,232,0.15)";
                }}
              >
